...
Seus 14 episódios tiveram as seguintes avaliações:
...
A linha azul representa a correlação entre à nota dada pelos usuários e a temporada. Podemos observar que há uma fraca correlação descendente, caracterizada pelo valor:
...
```
Com base nisto podemos dizer que a qulidade vista pelos exspectadores não tem relação alguma com o numéro de episódios por temporada.
